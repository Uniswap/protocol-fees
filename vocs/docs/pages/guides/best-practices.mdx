...
As noted in [System Permissions](/system-permissions), the Phoenix system allows for an *updatable* [`Firepit.threshold()`](/technical-reference/IResourceManager#threshold)
