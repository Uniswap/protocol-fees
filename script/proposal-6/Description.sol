...
string constant DESCRIPTION = "## Summary" ""
  ...
  "  * For all chains other than Base:" "    * Family Default: 10bp"
  "    * Select Stable Pairs: 3bp" "  * For Base: " "    * Family Default: 3bp"
  ...
  "---" "" "## Next Steps / Timeline" "" "**Snapshot:** July 7-12, 2026" ""
  ...
  "| :---- | :---- | :---- | :---- |" "| *0 \\- 0.03* | *0* | *0.01* | *0* |"
  "| *0.03 \\- 0.75* | *0.03* | *0.01* | *19/72* |" "| *0.75 \\- 1* | *0.75* | *0.2* | *0.2* |"
  "| *1 \\- 3.75*  | *1* | *0.25* | *3/11* |" "| *3.75 \\- 5* | *3.75* | *1* | *0.2* |"
  "| *5 \\- 25*  | *5* | *1.25* | *11/80* |" "| *25 \\- 55* | *25* | *4* | *0.2* |"
  "| *\\> 55* | *55* | *10* | *0* |" ""
  "This results in the following fees at the following points. " ""
  "| LP Fee (bps) | Protocol Fee (bps) |" "| :---- | :---- |" "| 0.03 | 0.01 |" "| .75 | 0.20 |"
  "| 1 | 0.25 |" "| 3.75 | 1 |" "| 5 | 1.25 |" "| 25 | 4 |" "| 30 | 5 |" "| 83.34 | 10 |"
  "| 100 | 10 |";
