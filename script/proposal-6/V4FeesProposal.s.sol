  ...
  function run() public {
    ...
    uniswap.loadLatest();
    {
      ...
      Call memory activateV4FeesEthereum = Call({
        ...
        value: 0,
        data: abi.encodeCall(IPoolManager.setProtocolFeeController, (V4FeeController.Ethereum))
      });
      ...
      Call memory activateV4FeesArbitrum = InboxEncoder.encode({
        ...
        remoteCall: Call({
          ...
          value: 0,
          data: abi.encodeCall(IPoolManager.setProtocolFeeController, (V4FeeController.Arbitrum))
        })
      });
      ...
      Call memory activateV4FeesBase = L1CrossDomainMessengerEncoder.encode({
        ...
        remoteCall: Call({
          ...
          value: 0,
          data: abi.encodeCall(IPoolManager.setProtocolFeeController, (V4FeeController.Base))
        })
      });
      ...
      Call memory activateV4FeesBNBChain = WormholeEncoder.encode({
        ...
        remoteCalls: LibCall.newCalls(
          [Call({
              ...
              value: 0,
              data: abi.encodeCall(
                IPoolManager.setProtocolFeeController, (V4FeeController.BNBChain)
              )
            })]
        )
      });
      ...
      Call memory activateV4FeesCelo = L1CrossDomainMessengerEncoder.encode({
        ...
        remoteCall: Call({
          ...
          value: 0,
          data: abi.encodeCall(IPoolManager.setProtocolFeeController, (V4FeeController.Celo))
        })
      });
      ...
      Call memory activateV4FeesOPMainnet = L1CrossDomainMessengerEncoder.encode({
        ...
        remoteCall: Call({
          ...
          value: 0,
          data: abi.encodeCall(IPoolManager.setProtocolFeeController, (V4FeeController.Optimism))
        })
      });
    ...
    }
    {
      ...
      Call memory activateV4FeesPolygon = FxRootEncoder.encode({
        ...
        remoteCalls: LibCall.newCalls(
          [Call({
              ...
              value: 0,
              data: abi.encodeCall(IPoolManager.setProtocolFeeController, (V4FeeController.Polygon))
            })]
        )
      });
      ...
      Call memory activateV4FeesSoneium = L1CrossDomainMessengerEncoder.encode({
        ...
        remoteCall: Call({
          ...
          value: 0,
          data: abi.encodeCall(IPoolManager.setProtocolFeeController, (V4FeeController.Soneium))
        })
      });
      ...
      Call memory activateV4FeesWorldchain = OptimismPortal2Encoder.encode({
        ...
        remoteCall: Call({
          ...
          value: 0,
          data: abi.encodeCall(IPoolManager.setProtocolFeeController, (V4FeeController.WorldChain))
        })
      });
      ...
      Call memory activateV4FeesXLayer = OptimismPortal2Encoder.encode({
        ...
        remoteCall: Call({
          ...
          value: 0,
          data: abi.encodeCall(IPoolManager.setProtocolFeeController, (V4FeeController.XLayer))
        })
      });
      ...
      Call memory activateV4FeesZora = L1CrossDomainMessengerEncoder.encode({
        ...
        remoteCall: Call({
          ...
          value: 0,
          data: abi.encodeCall(IPoolManager.setProtocolFeeController, (V4FeeController.Zora))
        })
      });
