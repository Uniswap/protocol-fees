...
library Ethereum {
  ...
  /// OpenFeeAdapter (owns V3Factory): cast call 0xf2371551Fe3937Db7c750f4DfABe5c2fFFdcBf5A "owner()(address)"
  /// PoolManager: `cast call 0x000000000004444c5dc75cB358380D2e3dE08A90 "owner()(address)"`
  ...
  /// queued delay.
  ///
  /// source: owns Timelock: `cast call 0x1a9C8182C09F50C8318d769245beA52c32BE35BC "admin()(address)"`
  address constant GOVERNOR_BRAVO = address(0x408ED6354d4973f66138C91495F2f2FCbd8724C3);

  /// @dev UNI Token.
  ///
  /// source: designated by GovernorBravo: `cast call 0x408ED6354d4973f66138C91495F2f2FCbd8724C3 "uni()(address)"`
  ...
  /// cosntructor arg (private immutable): https://etherscan.io/tx/0xcf516bddc8bffb979ae73c48a30cbce4612fc821795bf771f486189cf962f295
...
library Celo {
  /// @dev Uni V2 Factory.
  ///
  /// source: Governance-assigned ENS record (42220) https://app.ens.domains/v2deployments.uniswap.eth?tab=records
...
library BNB {
  uint256 constant RELEASER_THRESHOLD = 4_000e18;

  /// @dev Uni V2 Factory.
  ///
  /// source: https://github.com/Uniswap/briefcase/blob/42ce79f148d934ed62523e8cdea18a6886c4f93e/deployments/56.json#L87
  address constant V2_FACTORY = address(0x8909Dc15e40173Ff4699343b6eB8132c65e18eC6);

  /// @dev Uni V3 Factory.
  ///
  /// source: governance-assigned ens record (56) https://app.ens.domains/v2deployments.uniswap.eth?tab=records
  address constant V3_FACTORY = address(0xdB1d10011AD0Ff90774D0C6Bb92e5C5c8b4461F7);

  /// @dev Uni V4 Pool Manager.
  ///
  /// source: https://github.com/Uniswap/briefcase/blob/42ce79f148d934ed62523e8cdea18a6886c4f93e/deployments/56.json#L18
  ...
  address constant UNISWAP_WORMHOLE_MESSAGE_RECEIVER = address(0x341c1511141022cf8eE20824Ae0fFA3491F1302b);

  /// @dev Wormhole Core Bridge.
  ///
  /// source: immutable constructor arg to UNISWAP_WORMHOLE_MESSAGE_RECEIVER, linked in docs
  /// cosntructor arg (private immutable): https://bscscan.com/tx/0x4be120ae0b43fc5264d2de953947049d7a420f997fb11b9e04d66ec7b6b5339b
  /// note; it's the same as the one on ethereum
  address constant WORMHOLE = address(0x98f3c9e6E3fAce36bAAd05FE09d375Ef1464288B);
}

library Polygon {
  uint256 constant RELEASER_THRESHOLD = 2_000e18;
  ...
  /// @dev Uni V2 Factory.
  ///
  /// source: https://github.com/Uniswap/briefcase/blob/42ce79f148d934ed62523e8cdea18a6886c4f93e/deployments/137.json#L80
  address constant V2_FACTORY = address(0x9e5A52f57b3038F1B8EeE45F28b3C1967e22799C);

  /// @dev Uni V3 Factory.
  ///
  /// source: https://github.com/Uniswap/briefcase/blob/42ce79f148d934ed62523e8cdea18a6886c4f93e/deployments/137.json#L149
  address constant V3_FACTORY = address(0x1F98431c8aD98523631AE4a59f267346ea31F984);

  /// @dev Uni V4 Pool Manager.
  ///
  /// source: https://github.com/Uniswap/briefcase/blob/42ce79f148d934ed62523e8cdea18a6886c4f93e/deployments/137.json#L11
