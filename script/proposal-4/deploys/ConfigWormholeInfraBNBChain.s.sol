...
contract ConfigWormholeInfraBNBChainScript is Script {
    ...
    function loadDeployments() internal {
        ...
        bnb = Deployment({
            ...
            nttManagerImplementation: vm.parseJsonAddress(bnbDeployJson, ".transactions[2].contractAddress"),
            nttManagerProxy: vm.parseJsonAddress(bnbDeployJson, ".transactions[3].contractAddress"),
            wormholeTransceiverImplementation: vm.parseJsonAddress(bnbDeployJson, ".transactions[5].contractAddress"),
            wormholeTransceiverProxy: vm.parseJsonAddress(bnbDeployJson, ".transactions[6].contractAddress")
        });
