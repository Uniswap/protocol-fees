...
//
// cast call 0x98f3c9e6E3fAce36bAAd05FE09d375Ef1464288B "messageFee()(uint256)" --rpc-url
...
contract DeployWormholeInfraBNBChainScript is Script {
  ...
  function run() public {
    ...
    console2.log(
      "Wormhole                                                  : ", Constants.BNB.WORMHOLE
    );
    console2.log("\n");
    ...
    require(
      SyntheticNttUni(syntheticNttUni).owner() == Constants.BNB.UNISWAP_WORMHOLE_MESSAGE_RECEIVER
    );
    ...
    require(
      address(WormholeTransceiver(wormholeTransceiverProxy).wormhole()) == Constants.BNB.WORMHOLE
    );
