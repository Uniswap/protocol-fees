...
//
// cast call 0x7A4B5a56256163F07b2C80A7cA55aBE66c4ec4d7 "messageFee()(uint256)" --rpc-url https://polygon-bor-rpc.publicnode.com
//
...
contract DeployWormholeInfraPolygonScript is Script {
    ...
    function run() public {
        ...
        // Transaction 04
        //
        // Renounce pausing authority on NttManager proxy.
        //
        NttManagerNoRateLimiting(nttManagerProxy).transferPauserCapability(address(0x00));
        ...
        console2.log("Wormhole                                                  : ", Constants.Polygon.WORMHOLE);
        console2.log("\n");
        ...
        require(address(WormholeTransceiver(wormholeTransceiverProxy).wormhole()) == Constants.Polygon.WORMHOLE);
