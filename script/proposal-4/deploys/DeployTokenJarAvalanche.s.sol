...
address constant OWNER = Constants.Avalanche.OMNICHAIN_GOVERNANCE;
...
contract DeployTokenJarAvalanche is Script {
    ...
    function run() public {
        ...
        console2.log("=== Avalanche Deployment ===");
        vm.startBroadcast();
        ...
        v3OpenFeeAdapter = new V3OpenFeeAdapter{salt: SALT}(
            Constants.Avalanche.V3_FACTORY,
            address(tokenJar)
        );
