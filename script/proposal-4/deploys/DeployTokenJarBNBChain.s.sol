...
address constant OWNER = Constants.BNB.WORMHOLE_RECEIVER;
...
contract DeployTokenJarBNBChain is Script {
    ...
    function run() public {
        ...
        console2.log("=== BNBChain Deployment ===");
        vm.startBroadcast();
