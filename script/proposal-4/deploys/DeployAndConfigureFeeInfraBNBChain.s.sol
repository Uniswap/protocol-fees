...
contract DeployAndConfigureFeeInfraBNBChainScript is Script {
  ...
  function run() public {
    ...
    //
    tokenJar.transferOwnership({newOwner: Constants.BNB.UNISWAP_WORMHOLE_MESSAGE_RECEIVER});
    ...
    //
    releaser.setThresholdSetter({_thresholdSetter: Constants.BNB.UNISWAP_WORMHOLE_MESSAGE_RECEIVER});
    ...
    // - `newOwner`: Governance-owned Wormhole message receiver.
    //
    releaser.transferOwnership({newOwner: Constants.BNB.UNISWAP_WORMHOLE_MESSAGE_RECEIVER});
    ...
    //
    v3OpenFeeAdapter =
      new V3OpenFeeAdapter({_factory: Constants.BNB.V3_FACTORY, _tokenJar: address(tokenJar)});
    ...
    //
    v3OpenFeeAdapter.setFeeSetter({newFeeSetter: Constants.BNB.UNISWAP_WORMHOLE_MESSAGE_RECEIVER});
    ...
    // - `newOwner`: Governance-owned Wormhole message receiver.
    //
    v3OpenFeeAdapter.transferOwnership({newOwner: Constants.BNB.UNISWAP_WORMHOLE_MESSAGE_RECEIVER});
    ...
    console2.log(
      "V3OpenFeeAdapter                                          : ", address(v3OpenFeeAdapter)
    );
    console2.log("\n");
    ...
    console2.log(
      "tokenJar.releaser()                                       : ", tokenJar.releaser()
    );
    console2.log("WormholeReleaser                                          : ", address(releaser));
    console2.log("\n");
    ...
    console2.log(
      "releaser.thresholdSetter()                                : ", releaser.thresholdSetter()
    );
    console2.log(
      "Constants.BNB.UNISWAP_WORMHOLE_MESSAGE_RECEIVER           : ",
      Constants.BNB.UNISWAP_WORMHOLE_MESSAGE_RECEIVER
    ...
    console2.log(
      "v3OpenFeeAdapter.feeSetter()                              : ", v3OpenFeeAdapter.feeSetter()
    );
    console2.log(
      "Constants.BNB.UNISWAP_WORMHOLE_MESSAGE_RECEIVER           : ",
      Constants.BNB.UNISWAP_WORMHOLE_MESSAGE_RECEIVER
    ...
    console2.log(
      "v3OpenFeeAdapter.owner()                                  : ", v3OpenFeeAdapter.owner()
    );
    console2.log(
      "Constants.BNB.UNISWAP_WORMHOLE_MESSAGE_RECEIVER           : ",
      Constants.BNB.UNISWAP_WORMHOLE_MESSAGE_RECEIVER
    ...
    console2.log(
      "v3OpenFeeAdapter.TOKEN_JAR()                              : ", v3OpenFeeAdapter.TOKEN_JAR()
    );
    console2.log("TokenJar                                                  : ", address(tokenJar));
    console2.log("\n");
  ...
  function loadDeployments() internal {
    ...
    require(
      bnb.wormholeTransceiverImplementation.code.length != 0,
    ...
    //
    require(
      keccak256(bytes(SyntheticNttUni(bnb.uni).name())) == keccak256("Synthetic Ntt Uniswap"),
      "bnb.uni.name() mismatch"
    );
    require(
      keccak256(bytes(SyntheticNttUni(bnb.uni).symbol())) == keccak256("NUNI"),
      "bnb.uni.symbol() mismatch"
    );
    ...
    require(
      SyntheticNttUni(bnb.uni).owner() == Constants.BNB.UNISWAP_WORMHOLE_MESSAGE_RECEIVER,
      "bnb.uni.owner() mismatch"
    );
    ...
    require(
      readImplementation(bnb.nttManagerProxy) == bnb.nttManagerImplementation,
      "bnb.nttManagerProxy.implementation() mismatch"
    );
    require(
      NttManagerNoRateLimiting(bnb.nttManagerProxy).getMode() == uint8(IManagerBase.Mode.BURNING),
      "bnb.nttManagerProxy.mode() mismatch"
    );
    require(
      NttManagerNoRateLimiting(bnb.nttManagerProxy).token() == bnb.uni,
      "bnb.nttManagerProxy.token() mismatch"
    );
    require(
      NttManagerNoRateLimiting(bnb.nttManagerProxy).getThreshold() == 1,
      "bnb.nttManagerProxy.getThreshold() mismatch"
    );
    ...
    //
    require(
      readImplementation(bnb.wormholeTransceiverProxy) == bnb.wormholeTransceiverImplementation,
      "bnb.nttManagerProxy.implementation() mismatch"
    );
    require(
      WormholeTransceiver(bnb.wormholeTransceiverProxy).nttManager() == bnb.nttManagerProxy,
      "wormholeTransceiverProxy.nttManager() mismatch"
    );
    require(
      WormholeTransceiver(bnb.wormholeTransceiverProxy).nttManagerToken() == bnb.uni,
      "wormholeTransceiverProxy.nttManagerToken() mismatch"
    );
    require(
      WormholeTransceiver(bnb.wormholeTransceiverProxy).consistencyLevel() == 202,
      "wormholeTransceiverProxy.consistencyLevel() mismatch"
    );
    require(
      WormholeTransceiver(bnb.wormholeTransceiverProxy).customConsistencyLevel() == 0,
      "wormholeTransceiverProxy.customConsistencyLevel() mismatch"
    );
    require(
      WormholeTransceiver(bnb.wormholeTransceiverProxy).additionalBlocks() == 0,
      "wormholeTransceiverProxy.additionalBlocks() mismatch"
    );
    require(
      WormholeTransceiver(bnb.wormholeTransceiverProxy).customConsistencyLevelAddress()
        == address(0x00),
      "wormholeTransceiverProxy.customConsistencyLevelAddress() mismatch"
    );
    require(
      address(WormholeTransceiver(bnb.wormholeTransceiverProxy).wormhole())
